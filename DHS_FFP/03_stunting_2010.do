...
* Mother's education, contraception use, and wanted children
	clonevar motherEd = v106
	clonevar motherEdYears = v107
	
	clonevar idealChildNo = v614
	
	clonevar rohrer_idx = v446
	replace rohrer_idx = . if rohrer_idx == 9998
	replace rohrer_idx = (rohrer_idx/1000)
